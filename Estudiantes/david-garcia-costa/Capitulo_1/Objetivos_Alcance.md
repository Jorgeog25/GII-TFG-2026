...
1) Elaborar el modelo de dominio y definir la disciplina de requisitos del sistema.

2) Diseñar los agentes de IA necesarios para que el flujo funcione de manera óptima.

3) Desarrollar un prototipo funcional controlado.

4) Evaluar las ventajas y aportaciones del prototipo.
