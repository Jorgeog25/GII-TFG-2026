...
Los requisitos funcionales describen las funciones que debe ofrecer la solución desarrollada para dar respuesta a las necesidades identificadas en el apartado anterior. En este sentido, recogen tanto el tratamiento y cálculo de la información como la visualización y explotación de los resultados.

La solución debe cubrir los siguientes requisitos funcionales:
- Obtención de datos de planificación.
- Obtención de los datos reales de producción.
